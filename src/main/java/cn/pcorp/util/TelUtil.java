...
public class TelUtil {
	public static void main(String[] args) throws UnsupportedEncodingException {
		TelUtil.sendMessage(new String[] { "15201583182"}, "短信验证码."); 
	}
	public static void sendMessage(String[] to, String content) {
		...
		try {
			...
			for(String tel:to){				
			       Map params = new HashMap();//请求参数
		            ...
		            params.put("tpl_value","#code#="+content);//变量名和变量值对。如果你的变量名或者变量值中带有#&=中的任意一个特殊符号，请先分别进行urlencode编码后再传递，<a href="http://www.juhe.cn/news/index/id/50" target="_blank">详细说明></a>
	   ...
	   public static final String DEF_CHATSET = "UTF-8";
	    ...
	    //2.发送短信
	    public static void getRequest2(Map params){
	        String result =null;
